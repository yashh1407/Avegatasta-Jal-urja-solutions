        ...
        >
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="px-8 py-6 space-y-4">
              ...
              <div>
                <label className="text-[10px] font-black uppercase tracking-widest text-slate-500 block mb-1">Vendor Name *</label>
                <input className={inputClass} value={form.name} onChange={set('name')} required placeholder="e.g. SunPower Distributors" />
              </div>

              <div>
                <label className="text-[10px] font-black uppercase tracking-widest text-slate-500 block mb-1">Brand</label>
                <select className={inputClass} value={form.brand} onChange={set('brand')}>
              ...
              <div>
                <label className="text-[10px] font-black uppercase tracking-widest text-slate-500 block mb-1">Contact Person</label>
                <input className={inputClass} value={form.contact_person} onChange={set('contact_person')} placeholder="e.g. Ramesh Iyer" />
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input className={inputClass} type="email" value={form.email} onChange={set('email')} placeholder="vendor@example.com" />
                </div>
              </div>

              <div>
                <label className="text-[10px] font-black uppercase tracking-widest text-slate-500 block mb-1">Address</label>
                <input className={inputClass} value={form.address} onChange={set('address')} placeholder="Street address, city" />
              </div>
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
          <div>
            <div className="flex items-center gap-3 mb-2">
              ...
              <h1 className="text-4xl font-black text-blue-950 tracking-tight">Vendors</h1>
            </div>
                  ...
                  vendors.map((vendor) => (
                    ...
                    >
                      <td className="px-6 py-5">
                        <span className="font-black text-sm text-blue-950">{vendor.name}</span>
                        {vendor.address && (
