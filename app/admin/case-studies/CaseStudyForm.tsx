  ...
  return (
    <div className="max-w-3xl mx-auto space-y-8">
      ...
      <Link
        ...
        className="inline-flex items-center gap-2 text-sm font-black text-slate-500 hover:text-blue-600 transition-colors"
      >
        <ArrowLeft size={15} />
      ...
      <div className="bg-white rounded-[2.5rem] border border-slate-100 shadow-sm px-8 py-7 space-y-7">
        <h2 className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Images</h2>
          ...
          {coverPreview ? (
            <div className="relative inline-block">
              ...
              <button
                ...
                className="mt-2 text-xs font-black text-slate-400 hover:text-blue-600 transition-colors"
              >
                Replace
              </button>
            </div>
            ...
            <button
              type="button"
              onClick={() => coverInputRef.current?.click()}
              className="w-full border-2 border-dashed border-slate-200 rounded-2xl py-10 flex flex-col items-center gap-2 text-slate-400 hover:border-blue-300 hover:text-blue-500 transition-all"
            >
              <Upload size={24} />
          ...
          <div className="grid grid-cols-4 gap-3">
            ...
            {galleryPreviews.map((preview, i) => (
              <div key={`new-${i}`} className="relative">
                <div className="w-full aspect-square rounded-2xl overflow-hidden border-2 border-blue-200">
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img src={preview} alt="" className="w-full h-full object-cover" />
                </div>
                <div className="absolute top-1 left-1 w-4 h-4 bg-blue-600 rounded-full flex items-center justify-center shadow-sm">
            ...
            <button
              ...
              className="aspect-square border-2 border-dashed border-slate-200 rounded-2xl flex flex-col items-center justify-center gap-1.5 text-slate-400 hover:border-blue-300 hover:text-blue-500 transition-all"
            >
              <ImageIcon size={20} />
      ...
      <div className="flex items-center gap-3 justify-end pb-4">
        ...
        <button
          ...
          className="px-6 py-2.5 border border-blue-200 rounded-2xl text-sm font-black text-blue-600 hover:bg-blue-50 transition-all disabled:opacity-60 flex items-center gap-2"
        >
        ...
        <button
          ...
          className="px-6 py-2.5 bg-blue-600 hover:bg-blue-700 rounded-2xl text-sm font-black text-white transition-all disabled:opacity-60 flex items-center gap-2 shadow-lg shadow-blue-200"
        >
          {saving && <RefreshCw size={14} className="animate-spin" />}
          Publish
        </button>
